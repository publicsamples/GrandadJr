...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _gr2 -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _gr2SIG0 {
	...
	int getNumInputs_gr2SIG0() {
		return 0;
	}
	int getNumOutputs_gr2SIG0() {
		return 1;
	}
	
	void instanceInit_gr2SIG0(int sample_rate) {
	}
	
	void fill_gr2SIG0(int count, float* table) {
...
static _gr2SIG0* new_gr2SIG0() { return (_gr2SIG0*)new _gr2SIG0(); }
static void delete_gr2SIG0(_gr2SIG0* dsp) { delete dsp; }


struct _gr2 final : public ::faust::dsp {
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _gr2 -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	void instanceConstants(int sample_rate) {
		...
		_gr2SIG0* sig0 = new_gr2SIG0();
		sig0->instanceInit_gr2SIG0(sample_rate);
		sig0->fill_gr2SIG0(44100, ftbl0);
		fConst4 = 1.0f / fConst0;
		sig0->instanceInit_gr2SIG0(sample_rate);
		sig0->fill_gr2SIG0(44100, ftbl1);
		delete_gr2SIG0(sig0);
	}
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("gr2");
	...
	#define FAUST_FILE_NAME "gr2.dsp"
	#define FAUST_CLASS_NAME "_gr2"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _gr2 -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
